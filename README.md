...
좌측 메뉴 + 우측 컨텐츠 레이아웃. WinUI 3 Fluent(Mica 백드롭, 라이트/다크 테마) 적용.
...
- **그룹 구성**: "그룹 추가/수정" 다이얼로그에서 설치 앱을 체크박스로 선택해 그룹 생성/편집/삭제. 그룹 아이콘은 내장 색상 / 첫 멤버 앱 / 사용자 이미지(.png·.ico 등) 중 선택(미리보기 제공).
