...
public static class GroupArgs
{
    ...
    public static string? ParseCommandLine(string? commandLine) => ParseFlag(commandLine, GroupFlag);
    ...
    /// <summary>그룹 id로 "그룹 수정" 활성화 명령줄 인자를 만든다.</summary>
    public static string BuildEditCommandLineArguments(string groupId) => $"{EditFlag} {groupId}";
